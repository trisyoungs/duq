...
class Weights : public GenericItemBase
{
	...
	bool addIsotopologue(const Species* sp, int speciesPopulation, const Isotopologue* iso, double isotopologueRelativePopulation);
	// Return whether we have a mixtures definition for the provided Species
	Isotopologues* hasIsotopologues(const Species* sp) const;
