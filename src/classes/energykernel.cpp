...
{
    return a.energy(Box::angleInDegrees(box_->minimumVectorN(j, i), box_->minimumVectorN(j, k)));
}
...
{
    return t.energy(Box::torsionInDegrees(box_->minimumVector(j, i), box_->minimumVector(j, k), box_->minimumVector(k, l)));
}
...
{
    return imp.energy(Box::torsionInDegrees(box_->minimumVector(j, i), box_->minimumVector(j, k), box_->minimumVector(k, l)));
}
