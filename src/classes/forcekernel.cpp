...
{
    auto vecji = box_->minimumVector(i, j);
...
{
    auto vecji = box_->minimumVector(j, i);
    auto vecjk = box_->minimumVector(j, k);
                         ...
                         ForceVector &f) const
{
    ...
    auto vecji = box_->minimumVector(i, j);
    auto vecjk = box_->minimumVector(k, j);
    auto veckl = box_->minimumVector(l, k);
